...
console.log(data)
    ...
    return ( 
     ...
     {position?
    (<div className='flex mr-3 font-IBM bg-white text-black rounded-lg  flex-col top-[105px] absolute right-[29px] opacity-100 transform duration-400 ease-linear -translate-x-4'>
